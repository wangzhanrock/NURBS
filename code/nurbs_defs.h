...
//        os << "\ni = " << i << ", j = " << j << ": " << A.data[i * A.ncols + j];  // TODO: this function didn't recognize correct new A.data after calling A.resize();
        os << "\ni = " << i << ", j = " << j << ": " << A(i, j);  // TODO: this function does not works correctly. can not debug!!
        std::cout << A.data[i * A.ncols + j];
      }
